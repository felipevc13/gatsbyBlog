...
export type Unnamed_1_Query = { avatarImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<Pick<ImageSharpFluid, 'base64' | 'aspectRatio' | 'src' | 'srcSet' | 'sizes'>> }> }> };

export type MySiteMetadataQueryVariables = Exact<{ [key: string]: never; }>;


export type MySiteMetadataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'position' | 'description'>> }> };
...
export type PostListPagQueryVariables = Exact<{
  skip: Scalars['Int'];
  limit: Scalars['Int'];
}>;


export type PostListPagQuery = { allMarkdownRemark: { edges: Array<{ node: (
...
export type PostQuery = { markdownRemark?: Maybe<(
    ...
    & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'date'>
      & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<Pick<ImageSharpFluid, 'base64' | 'sizes' | 'aspectRatio' | 'src' | 'srcSet'>> }> }> }
    )> }
  )> };
